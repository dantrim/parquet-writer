...
Running the `dump-metadata.py` script on the Parquet file generated by [examples/basic_example](examples/cpp/basic_example.cpp)
looks like,
```verbatim
$ ./build/bin/basic_example # generates the Parquet file "example_dataset/example_dataset_0000.parquet"
