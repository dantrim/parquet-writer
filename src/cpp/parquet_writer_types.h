...
//                     buffer_value_vec3d_t>
typedef std::variant<buffer_value_t, std::vector<buffer_value_t>> buffer_t;
// clang-format on
};  // namespace types

// convenience types to hide some internal ugly names
typedef types::buffer_t value_t;
...
typedef std::vector<value_t> struct_list3d;
typedef std::vector<value_t> struct_list2d;
typedef std::vector<value_t> struct_list1d;
};  // namespace parquetwriter
