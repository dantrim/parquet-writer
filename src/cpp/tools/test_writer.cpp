...
int main(int argc, char* argv[]) {
    ...
    pw::pstruct col13_data{col13_field_foo, col13_field_bar};
    // col14
    pw::struct_list1d col14_data;
    for (size_t i = 0; i < 5; i++) {
        pw::pstruct col14_element_field_data;
    ...
    for (size_t i = 0; i < 3; i++) {
        std::vector<pw::pstruct> inner_data;
        for (size_t j = 0; j < (i + 1); j++) {
            pw::pstruct col18_element_field_data;
    ...
    for (size_t i = 0; i < 5; i++) {
        std::vector<std::vector<pw::pstruct>> inner3_data;
        for (size_t j = 0; j < 3; j++) {
            std::vector<pw::pstruct> inner2_data;
            for (size_t k = 0; k < 2; k++) {
                pw::pstruct col19_element_field_data;
