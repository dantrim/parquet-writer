...
int main(int argc, char* argv[]) {
    ...
    // the "basic_struct" column holds a single struct element in each row (it is flat)
    pw::struct_element basic_struct_data{float_field_data, int_field_data, list_field_data};
    ...
    for(size_t i = 0; i < 7; i++) {
        pw::struct_element struct_data{float_field_data, int_field_data, list_field_data};
